...
class CardOutlookSendEmail extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className="column mr-3"><figure className="image is-64x64 mb-5">
                ...
                <p className="is-size-7">Sur: <span className="has-text-weight-bold">{this.state.email}</span></p>
...
export default withRouter(connect(mapStateToProps)(CardOutlookSendEmail));