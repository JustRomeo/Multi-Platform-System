...
class CardGoogleGetNewVideo extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className="column mr-3"><figure className="image mb-5 mt-2">
                ...
                <p className="is-size-6">Nouvelle vidéo de : <span className="has-text-weight-bold">{this.state.channel_name}</span></p>
            </div>
        );
    }
}
...
export default withRouter(connect(mapStateToProps)(CardGoogleGetNewVideo));