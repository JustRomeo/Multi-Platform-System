...
class CardIntraMissed extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className="column ml-3"><figure className="image mb-5 mt-2">
                ...
                <p className="is-size-6">Déclenché lorsque vous avez une absence</p>
            </div>
        );
    }
}
...
export default withRouter(connect(mapStateToProps)(CardIntraMissed));